...
button_add_image = load_image('image/button/add',True, 6)
button_top_image = load_image('image/button/topory',True, 4)
...
key_sound = pygame.mixer.Sound('sound/key.mp3')
game_over_sound = pygame.mixer.Sound('sound/game_over.mp3')
button_sound = pygame.mixer.Sound('sound/button.mp3')
enemy_sound = pygame.mixer.Sound('sound/enemy.mp3')
level_sound = pygame.mixer.Sound('sound/level.mp3')
win_sound = pygame.mixer.Sound('sound/win.mp3')
life_sound = pygame.mixer.Sound('sound/life.mp3')
topor_add_image = pygame.image.load('image/topor/top_fon.png').convert_alpha()