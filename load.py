...
coin_image = load_image('image/decorate/coin')
...
player_image_left = load_image('image/player/left')
player_image_up = load_image('image/player/up')
...
enemy_image_left = load_image('image/enemy/left')
